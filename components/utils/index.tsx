...
import { CreateVLandPolicyModel, CreateBuildingPolicyModel , CreateUnitPolicyModel , CreateOfficePolicyModel
           , CreateShopPolicyModel , CreateUnderConstPolicyModel, CreateVillaPolicyModel  } from '../../Models/PolicyLandModel';



 type VLandReducerAction<T extends keyof CreateVLandPolicyModel> = {
  payload: CreateVLandPolicyModel[T];
  type: T;
};

type BuildReducerAction<T extends keyof CreateBuildingPolicyModel> = {
  payload: CreateBuildingPolicyModel[T];
  type: T;
};

type UnitReducerAction<T extends keyof CreateUnitPolicyModel> = {
  payload: CreateUnitPolicyModel[T];
  type: T;
};

type OfficeReducerAction<T extends keyof CreateOfficePolicyModel> = {
  payload: CreateOfficePolicyModel[T];
  type: T;
};

type ShopReducerAction<T extends keyof CreateShopPolicyModel> = {
  payload: CreateShopPolicyModel[T];
  type: T;
};

type UnderConstReducerAction<T extends keyof CreateUnderConstPolicyModel> = {
  payload: CreateUnderConstPolicyModel[T];
  type: T;
};

type VillaReducerAction<T extends keyof CreateVillaPolicyModel> = {
  payload: CreateVillaPolicyModel[T];
  type: T;
};
...
export function inputVLandReducer<T extends keyof CreateVLandPolicyModel>(
  vland: CreateVLandPolicyModel,
  action: VLandReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...vland, [action.type]: action.payload };
    default:
      return vland;
  }
}

export function inputBuildReducer<T extends keyof CreateBuildingPolicyModel>(
  build: CreateBuildingPolicyModel,
  action: BuildReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...build, [action.type]: action.payload };
    default:
      return build;
  }
}

export function inputUnitReducer<T extends keyof CreateUnitPolicyModel>(
  unit: CreateUnitPolicyModel,
  action: UnitReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...unit, [action.type]: action.payload };
    default:
      return unit;
  }
}

export function inputOfficeReducer<T extends keyof CreateOfficePolicyModel>(
  office: CreateOfficePolicyModel,
  action: OfficeReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...office, [action.type]: action.payload };
    default:
      return office;
  }
}
 
export function inputShopReducer<T extends keyof CreateShopPolicyModel>(
  shop: CreateShopPolicyModel,
  action: ShopReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...shop, [action.type]: action.payload };
    default:
      return shop;
  }
}

export function inputUnderConstReducer<T extends keyof CreateUnderConstPolicyModel>(
  underconst: CreateUnderConstPolicyModel,
  action: UnderConstReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...underconst, [action.type]: action.payload };
    default:
      return underconst;
  }
}

export function inputVillaReducer<T extends keyof CreateVillaPolicyModel>(
  villa : CreateVillaPolicyModel,
  action: VillaReducerAction<T>
) {
  switch (action.type) {
    case action.type:
      return { ...villa, [action.type]: action.payload };
    default:
      return villa;
  }
}
...
export const songsData = [
  {
    ...
    cover: require('../../assets/demo-img/song-1.jpg'),
    id: '0',
    title: 'Song title no 0',
  },
  {
    artist: 'The artist no 1',
    cover: require('../../assets/demo-img/song-2.jpg'),
    id: '1',
...
export const albumsData = [
  {
    ...
    cover: require('../../assets/demo-img/artist-1.jpg'),
    id: '0',
    title: 'Album title no 0',
  },
  {
    artist: 'The artist no 1',
    cover: require('../../assets/demo-img/artist-2.jpg'),
    id: '1',
...
export const restaurantsData = [
  {
    cover: require('../../assets/demo-img/restaurant-1.jpg'),
    id: '0',
    name: 'Restaurant no 0',
    price: 1,
  },
  {
    cover: require('../../assets/demo-img/restaurant-2.jpg'),
    id: '1',
