    ...
    <View style={{ flex: 1 }}>
      <PagerView style={styles.pagerView} initialPage={0} ref={pagerRef}>
        ...
        <ScrollView contentContainerStyle={styles.page} key="1">
          <Text style={styles.header}>{i18n.t('shopform')}</Text>
          ...
          >
            <Text style={styles.label}>{i18n.t('shoptype')}</Text>
            <View style={styles.pickerWrapper}>
              <Picker
                style={{ height: 70 }}
        ...
        <ScrollView contentContainerStyle={styles.page} key="2">
          <Text style={styles.header}>{i18n.t('evaluationshop')}</Text>
          ...
          >
            ...
            <Text style={styles.label}>{i18n.t('expectedincome')}</Text>
