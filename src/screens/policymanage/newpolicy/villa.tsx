...
import { creatvillapolicy_api, e, getvillapolicy_api, updatevillapolicy_api } from '@/constant/DXBConstant';
...
export default function VillaPolicy({ navigation, route }: any) {
  ...
  useEffect(() => {
    const loadPolicy = async () => {
      ...
      try {
        ...
        const res = await axios.get(getvillapolicy_api, {
          params: { policyid },
        });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        isEdit ? updatevillapolicy_api : creatvillapolicy_api,
        {
          method: 'POST',
          body: ServerData,
          headers: {
