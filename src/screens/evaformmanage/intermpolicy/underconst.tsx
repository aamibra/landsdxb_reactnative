...
import { e, evaluateunderconstform_api, getunderconstform_api } from '@/constant/DXBConstant';
...
export default function UnderConstPolicy({ navigation, route }: any) {
  ...
  useEffect(() => {
    const loadPolicy = async () => {
      ...
      try {
        const res = await api.get(getunderconstform_api, {
